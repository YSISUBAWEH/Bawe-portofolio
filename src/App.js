     ...
     <header className="header">
        <div className="container">
            <ul className="social-icons pt-3">
                ...
                <li className="social-item"><a className="social-link text-light" href="https://github.com/YSISUBAWEH"><i className="ti-github" aria-hidden="true"></i></a></li>
            </ul>  
            <div className="header-content">
                <h4 className="header-subtitle" >Hello, I am</h4>
                <h1 className="header-title">Subaweh</h1>
                <h6 className="header-mono" >Progammer | Student of SMKN 6 Jember</h6>
                <a href="#about" className="btn btn-primary btn-rounded p-2">Mulai Sekarang</a>
            </div>
        </div> 
    </header>
